...
function loadHTMLEditor() {
    // element_type = document.getElementById('ele_type').value;
    // if (element_type == "Header")
    // {
    //     temp = content + '<h1 class="text-primary">Header</h1>\n'
    //     document.getElementById('ele_type').value = "Select Your Option"
